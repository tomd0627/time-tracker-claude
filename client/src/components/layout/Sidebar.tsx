  ...
  return (
    <aside className={cn(
      ...
      <div className={cn(
        ...
        <span className={cn('font-bold text-gray-900 dark:text-white text-sm', collapsed && 'md:hidden')}>
          Time Tracker
        </span>
        ...
        <button
          ...
          className="md:hidden ml-auto btn-ghost btn-sm p-1.5 rounded-lg"
      ...
      <div className="p-3 border-t border-gray-100 dark:border-gray-800 flex items-center gap-2">
        <button
          ...
          className={cn('btn-ghost btn-sm rounded-lg p-2', collapsed && 'md:w-full md:justify-center')}
